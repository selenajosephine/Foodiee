...
<h1 style="margin-top:100px;" >Payment type</h1>
<form action="ControllerServlet" mehtod="get">
<label class="container">&nbsp;&nbsp;&nbsp;card
  <input type="radio" checked="checked" value="card" name="type">
  <span class="checkmark"></span>
</label>
<label class="container">&nbsp;&nbsp;&nbsp;salary
  <input type="radio" value="salary" name="type">
  <span class="checkmark"></span>
</label>
<br>
<button style="margin-left:100px;" class="button" type="submit" value="placeorder" name="action">Pay</button>
</form>
